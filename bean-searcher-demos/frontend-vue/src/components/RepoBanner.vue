<template>
  <div class="repo-banner">
    ...
    <div class="repo-links">
      <a href="https://github.com/troyzhxu/bean-searcher" target="_blank" class="repo-icon-link" title="GitHub">
      ...
      <a href="https://gitee.com/troyzhxu/bean-searcher" target="_blank" class="repo-icon-link gitee" title="Gitee">
        <svg class="repo-icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
...
.repo-icon-link:hover {
  box-shadow: 0 4px 20px rgba(91,90,247,.2);
  transform: translateY(-2px);
  color: #5b5af7;
}

.repo-icon-link.gitee {
  color: #c71d23ce;
}

.repo-icon-link.gitee:hover {
  box-shadow: 0 4px 20px rgba(199,29,35,.25);
  color: #c71d23;
}

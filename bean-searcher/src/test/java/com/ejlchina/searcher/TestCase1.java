    ...
    public void test1() {
        SqlExecutor sqlExecutor = new SqlExecutor() {
            ...
            public <T> SqlResult<T> execute(SearchSql<T> searchSql) {
                Assert.assertEquals("select name c_1, id c_0 from bean limit ?, ?", searchSql.getListSqlString());
                ...
                Assert.assertEquals("select count(*) s_count from bean", searchSql.getClusterSqlString());
    ...
    public void test2() {
        SqlExecutor sqlExecutor = new SqlExecutor() {
            ...
            public <T> SqlResult<T> execute(SearchSql<T> searchSql) {
                ...
                Assert.assertEquals("select name c_1, id c_0 from bean where (id = ?) limit ?, ?", searchSql.getListSqlString());
                List<Object> listParams = searchSql.getListSqlParams();
                ...
                Assert.assertEquals("select count(*) s_count from bean where (id = ?)", searchSql.getClusterSqlString());

...
```groovy
implementation 'cn.zhxu:bean-searcher-boot-stater:4.2.3'
```
...
```groovy
implementation 'cn.zhxu:bean-searcher-solon-plugin:4.2.3'
```
...
```groovy
implementation 'cn.zhxu:bean-searcher:4.2.3'
```

...
```groovy
implementation 'com.ejlchina:bean-searcher-boot-stater:3.8.0'
```
...
```groovy
implementation 'com.ejlchina:bean-searcher:3.8.0'
```
...
[**[ JsonKit ]** 超轻量级 JSON 门面工具，用法简单，不依赖具体实现，让业务代码与 Jackson、Gson、Fastjson 等解耦！](https://gitee.com/troyzhxu/jsonkit)
